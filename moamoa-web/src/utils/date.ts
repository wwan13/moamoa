 ...
 */
export const toDate = (input: unknown): Date | null => {
  // 배열
...
export const formatDate = (
  ...
  const showTime = Array.isArray(input) ? input.length >= 5 : true // 문자열/Date는 기본 시간 표시
 ...
 */
export const formatRelativeDate = (input: unknown): string => {
