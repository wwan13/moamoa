...
const LeftSidebar = ({
    ...
    const updateSidebarHeight = useCallback(() => {
        ...
        const nextHeight = Math.max(0, Math.floor(window.innerHeight - rectTop - 16))
    ...
    const updateOverflow = useCallback(() => {
        ...
        if (!el || !wrapEl || !allButtonEl || !subscribedButtonEl || !bookmarkButtonEl) {
        ...
        const reservedHeight = allButtonEl.offsetHeight
    ...
    return (
        <aside
            ...
            style={sidebarHeight !== null ? { height: `${sidebarHeight}px` } : undefined}
        >
            <button
                ref={allButtonRef}
                type="button"
