...
const TechBlogItem = ({ techBlog, isSkeleton = false, onItemClick }: TechBlogItemProps) => {
    ...
    const patchBlog = (techBlogId: number, patcher: (blog: TechBlogSummary) => TechBlogSummary) => {
        qc.setQueriesData(
