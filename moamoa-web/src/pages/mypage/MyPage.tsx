...
const MyPage = () => {
  ...
  const showSkeleton = memberSummaryQuery.isPending
  ...
  return (
    <div className={styles.wrap}>
      ...
      {showSkeleton ? (
        <div>
          <div
            className={`${styles.title} ${styles.skeleton} ${styles.skeletonTitle}`}
          ></div>
          <div className={styles.stats}>
            <div className={styles.stat}>
              ...
              <div
                className={`${styles.statValue} ${styles.skeleton} ${styles.skeletonStat}`}
              ></div>
            </div>
            <div className={styles.stat}>
              <div className={styles.statTitle}>
