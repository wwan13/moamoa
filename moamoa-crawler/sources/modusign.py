...
KEY = "modusign"
BASE_URL = "https://team.modusign.co.kr"


def is_post_url(url: str) -> bool:
    parsed = urllib.parse.urlsplit(url)
    if parsed.netloc != "team.modusign.co.kr":
        return False
...
def crawl(request, config) -> dict[str, object]:
    return card_browser_posts(
        ...
        no_posts_message="modusign browser crawl finished but no post links were extracted from /all",
    )
