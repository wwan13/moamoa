...
@Configuration
@EnableConfigurationProperties(SetRedisProperties::class)
internal class SetRedisConfig {

    @Bean
    fun setRedisConnectionFactory(properties: SetRedisProperties): RedisConnectionFactory {
    ...
    @Bean
    fun setStringRedisTemplate(
        @Qualifier("setRedisConnectionFactory") connectionFactory: RedisConnectionFactory,
