...
internal class QueueRedisConfig {

    @Bean
    fun queueRedisConnectionFactory(properties: QueueRedisProperties): RedisConnectionFactory {
    ...
    @Bean
    fun queueStringRedisTemplate(
        @Qualifier("queueRedisConnectionFactory") connectionFactory: RedisConnectionFactory,
