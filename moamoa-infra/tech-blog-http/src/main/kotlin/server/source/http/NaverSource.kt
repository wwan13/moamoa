...
internal class NaverSource(
    ...
    override suspend fun getPosts(size: Int?): Flow<TechBlogPost> {
        val listFlow: Flow<TechBlogPost> =
            fetchWithPaging(pageSize = 20, targetCount = size, startPage = 0) { pageSize, page ->
