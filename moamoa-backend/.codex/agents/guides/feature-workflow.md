...
- `core-api`, `admin`, `core-web`, `admin-web` 작업을 안전하게 병렬화한다.
...
### 권장 분할
- worker 1: `moamoa-backend/core/core-api/**`
- worker 2: `moamoa-backend/admin/**`
- worker 3: `moamoa-frontend/core-web/**`
- worker 4: `moamoa-frontend/admin-web/**`
...
- core-web/admin-web 빌드 또는 타입 체크
- 인증/인가 흐름
- 검증 실패 시 에러 응답 형태
