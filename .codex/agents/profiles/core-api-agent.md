---
name: core-api-agent
description: "moamoa-core/core-api 전용 작업 agent"
---

# Core API Agent

## 범위
- 대상 모듈: `moamoa-core/core-api`
- 허용 경로: `/Users/taewan/dev/moamoa/moamoa-core/core-api/**`
...
## 금지
- `moamoa-admin/admin-api/**` 수정 금지 (절대)
- 타 모듈 파일 수정 금지
