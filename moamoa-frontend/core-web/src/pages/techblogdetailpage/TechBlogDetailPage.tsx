...
const TechBlogDetailPage = () => {
  ...
  const techBlogQk = useMemo(
    () => ["techBlog", scope, techBlogId],
    [scope, techBlogId],
  )

  const patchTechBlogDetail = (
      ...
      <div className={styles.blogInfo}>
        <div className={styles.iconWrap}>
          {techBlogQuery.isPending ? (
            <div
              className={`${styles.icon} ${styles.skeleton} ${styles.skeletonIcon}`}
            />
          ) : (
            <img
              src={techBlog?.icon || ""}
            ...
            {techBlogQuery.isPending ? (
              ...
              <>
                ...
                <button
                  ...
                  onClick={() =>
                    techBlog?.blogUrl && window.open(techBlog.blogUrl)
                  }
                >
                  {techBlog?.blogUrl || ""}
                </button>
