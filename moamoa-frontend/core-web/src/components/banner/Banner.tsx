  ...
  return (
    <div className={styles.wrap}>
      ...
      <div className={styles.ornaments} aria-hidden="true">
        ...
        <div className={`${styles.ornament} ${styles.ornamentRed}`}>user</div>

        <div className={`${styles.ornament} ${styles.ornamentTeal}`}>blog</div>
      ...
      <div className={styles.backgroud}>
        <div className={styles.bgRow} style={{ transform: "translateX(-2%)" }}>
        ...
        <div className={styles.bgRow} style={{ transform: "translateX(0%)" }}>
        ...
        <div className={styles.bgRow} style={{ transform: "translateX(-1%)" }}>
